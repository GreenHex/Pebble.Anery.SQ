...
#define STATUS_WINDOW_SIZE_H ( PBL_DISPLAY_HEIGHT - CLOCK_DIAL_SIZE_H - ( CLOCK_DIAL_POS_Y * 3 ) )
#define STATUS_WINDOW_POS_Y ( CLOCK_DIAL_SIZE_H + 2 * CLOCK_DIAL_POS_Y )
